...
<html>
    ...
    <body>
        ...
        <div class="top-container">          
            ...
            %>
            <h3> THIS TRANSACTION TOTAL : <%=value%></h3>
            <div style="position: absolute; left: 20%; top: 20%; width: 200px;"><a href="userProfile.jsp">MY CART</a> </div>
            <div style="position: absolute; left: 27%; top: 20%; width: 200px;"><a>BACK TO HOME</a> </div>
        </div>
        <div class="sidenav-6">
            <%
