 ...
 * @author Amal
 */
@WebServlet(urlPatterns = {"/searchByBrandServlet"})
public class searchByBrandServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ses.setAttribute("lwrP", lowerPrice);
        ses.setAttribute("higher", highestPrice);

        response.sendRedirect("productListSearch.jsp");
