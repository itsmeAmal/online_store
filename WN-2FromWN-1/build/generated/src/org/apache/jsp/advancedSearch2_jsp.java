...
public final class advancedSearch2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  while (rset.next()) {
      ...
      out.write("             color: #ffffff; font-weight: 500;\" ></div>\n");
      out.write("        <form action=\"advanceSearch\" method=\"post\">\n");
      out.write("            <div style=\"position: relative; left: 44%; top: -120%; width: 20%; height: 40px;\" >\n");
      out.write("                <input type=\"text\" class=\"form-control\" name=\"searchValue\" id=\"search\" placeholder=\"SEARCH\" /> \n");
      out.write("            </div>\n");
      out.write("            <div style=\"position: relative; left: 44%; top: 50%; width: 400px; height: 40px;\" >\n");
      out.write("                <input style=\"width: 375px;\" class=\"btn btn-info\" type=\"submit\" name=\"search\"> \n");
      out.write("            </div>\n");
      out.write("        </form>\n");
      out.write("\n");
      out.write("    </div>\n");
