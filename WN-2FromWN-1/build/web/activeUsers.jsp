    ...
    <body>
        ...
        <div class="header" id="myHeader">
            <div style="position: relative; left: 20%; top: 10%; width: 300px; height: 30px; font-size: 20px;
                 color: #ffffff; font-weight: 500;"><a href="controlPanel.jsp">CONTROL PANEL</a></div>
            ...
            <div class="container" style="position: absolute; left: 5%; top: 3%; width: 90%; height: max-content; background-color: #ffffff;">
                <table class="table table-responsive">   
                    ...
                    <th>ACTION</th>
                        ...
                        %>
                    <tr>                       
                        <td style="width: 300px; height: 100px; font-size: medium; text-align: left; top: 30%; font-weight: 100; "><%=rset.getString("user_name")%> 
                        </td>
                        ...
                        <td style="position:  relative; font-size: medium; text-align: left; top: 30%; font-weight: 600; color: #ff0000;">
                            <%=rset.getString("user_contact")%>   
                        </td>
                        <td>
                            <form action="deactivateUser" method="post"> 
                                <div style="position: relative; left: 0%; top: 10px; width: 100%; height: 30px;">
                                    <input type="hidden" name="hdnUid" value="<%=rset.getString("user_id")%>"> 
                                    <input class="btn btn-success" type="submit" value="DEACTIVATE" style="width: 150px; background-color: #990099;"/>
                                </div>
                            </form>  
